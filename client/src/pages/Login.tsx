...
export default function Login() {
  ...
  useGlassmorphism(glassRef as React.RefObject<HTMLElement>);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream via-g100 to-cream flex items-center justify-center px-4 overflow-hidden login-bg"
      style={{
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-text-mid text-lg">Sign in to your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                />
                <div className="absolute inset-0 rounded-lg opacity-0 group-focus-within:opacity-100 transition-opacity"
                  style={{
                    boxShadow: "inset 0 0 20px rgba(82, 183, 136, 0.1)",
                  }}
                />
              </div>
              {errors.phone && (
